function y=VP_rob_righthandside(t,x,gamma)
...
y=-(diffW+errormatrixD(t,x))*x-(gamma+t^gamma)*AFpowersigmoid(LIVEmatrixW(t,x)*x-LIVEvectoru(t,x))+diffu+errorvectorm(t,x);
