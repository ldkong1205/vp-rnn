...
global aa alpha_i a_i d_i D sa ca s2a c2a pen_long q0 T m gamma n Time znn_W k tt errorr K;
...
ry=aa*(cos(phi)*fac)+iy0-0.0359155;%T/2/pi;%chuyi/2
rz=0+iz0;
...
%%%%%%%%%%%%%%%%%????
delt_D=0.1*[sin(t/T*pi) cos(t/T*pi) -sin(2*t/T*pi) cos(t/T*pi) -sin(t/T*pi) cos(3*t/T*pi) -sin(t/T*pi) cos(t/T*pi) -sin(t/T*pi);...
...
delt_s=0.1*[2*sin(t/T*pi);4*cos(2*t/T*pi);-5*sin(3*t/T*pi); cos(3*t/T*pi); -sin(3*t/T*pi); 3*cos(t/T*pi);-sin(t/T*pi);-sin(2*t/T*pi);cos(t/T*pi)];
...
% dotyy=-(znn_dotQ+delt_D)*yy-gamma*exp(t)*AFsigmoid(znn_Q*yy-znn_u)+znn_dotu+delt_s;
% dotyy=-(znn_dotQ+delt_D)*yy-gamma*exp(t)*AFMpowersigmoid(znn_Q*yy-znn_u)+znn_dotu+delt_s;
